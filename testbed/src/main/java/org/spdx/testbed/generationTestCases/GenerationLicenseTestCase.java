...
public class GenerationLicenseTestCase extends GenerationTestCase {
    ...
    public SpdxDocument buildReferenceDocument() throws InvalidSPDXAnalysisException {
        ...
        var extractedLicenseInfo1 = new ExtractedLicenseInfo(modelStore, documentUri, "LicenseRef" +
                "-1", copyManager, true);
        ...
        var extractedLicenseInfo2 = new ExtractedLicenseInfo(modelStore, documentUri, "LicenseRef" +
                "-two", copyManager, true);
        ...
        var alladinWithException = LicenseInfoFactory.parseSPDXLicenseString("Aladdin WITH " +
        ...
        var licenseRef1WithException = LicenseInfoFactory.parseSPDXLicenseString("LicenseRef-1 " +
                "WITH u-boot-exception-2.0", modelStore, documentUri, copyManager);
    ...
    public String getName() {
        return TestCaseName.GENERATION_LICENSE.getFullName();
    }
}
