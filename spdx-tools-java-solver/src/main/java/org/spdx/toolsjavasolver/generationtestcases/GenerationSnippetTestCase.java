...
/**
 * Test case covering snippet properties.
 */
public class GenerationSnippetTestCase {
  ...
  public static SpdxDocument buildDocument() throws InvalidSPDXAnalysisException {
    ...
    var spdxSnippet = document.createSpdxSnippet("SPDXRef-somesnippet", "snippet name", gpl20Only,
            List.of(gpl20Only), "Copyright 2022 Jane Doe", file, 100, 400)
