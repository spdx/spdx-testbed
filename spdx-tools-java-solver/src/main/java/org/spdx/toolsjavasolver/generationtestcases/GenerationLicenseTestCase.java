...
public class GenerationLicenseTestCase {
  ...
  public static SpdxDocument buildDocument() throws InvalidSPDXAnalysisException {
    ...
    var licenseRef1WithExceptionOr2 = document.createDisjunctiveLicenseSet(
        List.of(licenseRef1WithException, licenseRef2));
    var declaredLicense = document.createConjunctiveLicenseSet(
        List.of(licenseRef1or2, alladinWithException));
    var concludedLicense = document.createConjunctiveLicenseSet(
        List.of(licenseRef1WithExceptionOr2, alladinWithException));
